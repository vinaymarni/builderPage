        ...
        <div className="notification-con ver-order">
            <div className="brochure-box flex-start-order">
                ...
                <div className="hor-order">
                    ...
                    <div>
                        <i id="cross-icon" className="fa fa-close" style={{fontSize:"20px", left:"265px"}} onClick={()=>onEnquire()}></i>
                        ...
                        <button className="call-btn download-btn">Enquire Now</button>
                    </div>
                </div>
            </div>
        </div>
